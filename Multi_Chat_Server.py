...
class Client():
    ...
    def __init__(self, name, conn, addr, room):                                                                                                                      #the word self is used to represent the instance of the class and to access the all the instances in aclass
        self._clientName = name                                                                                                                               #init is reserved method in python
