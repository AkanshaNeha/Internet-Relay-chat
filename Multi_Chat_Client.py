...
import tkinter, threading   #tkinter framework provides simple way to create gui
from cryptography.fernet import Fernet   # fernet is use to encrypt and decrypt the data
from socket import * 
import sys
...
class ChatWindow:
    ...
    def __init__(self):
        ...
        self._ip_field_label = tkinter.Label(master=self._main_frame, text="IP:", font="Time 11 bold")
        ...
        self._port_label = tkinter.Label(master=self._main_frame, text="Port:", font="Time 11 bold")
        ...
        self._connect_btn = tkinter.Button(master=self._main_frame, command=self.connect, text="Connect", font="Time 11 bold")
        ...
        self._confirm_nickname_btn = tkinter.Button(master=self._nickname_frame, command=self.change_name, text="Change Name", font="Time 11 bold")
        ...
        self._defaultRoom_btn = tkinter.Button(master=self._room_frame, command=self.move_default_room, text="Default Room", font="Time 11 bold")
        self._defaultRoom_btn.grid(row=0, column=2, padx=5, pady=5)

        self._add_room_btn = tkinter.Button(master=self._room_frame, command=lambda: self.add_room(True), text="Add Room", font="Time 11 bold")
        ...
        self._send_btn = tkinter.Button(master=self._send_frame, command=self._message, text="Send", font="Time 11 bold")
        self._send_btn.grid(row=0, column=0, padx=5, pady=5, sticky=tkinter.W)

        self._list_btn = tkinter.Button(master=self._send_frame, command=self.get_member_list, text="List Members", font="Time 11 bold")
        ...
        self._info_label = tkinter.Label(master=self._error_frame, text="No errors", font="Time 11 bold")
